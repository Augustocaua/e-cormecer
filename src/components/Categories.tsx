...
const categories = [
  { name: "Audio", slug: "audio", icon: Headphones, color: "from-blue-500 to-cyan-500" },
  { name: "Acessórios", slug: "acessorios", icon: Cable, color: "from-purple-500 to-pink-500" },
  { name: "Carregadores", slug: "carregadores", icon: Battery, color: "from-orange-500 to-red-500" },
  { name: "Smartphones", slug: "smartphones", icon: Smartphone, color: "from-green-500 to-emerald-500" },
];
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {categories.map((category, index) => {
          ...
          return (
            <Card
              key={category.name}
              className="group cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-medium hover:-translate-y-1"
            >
