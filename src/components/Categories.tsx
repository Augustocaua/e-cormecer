      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {categories.map((category) => {
          ...
          return (
            <Card
              key={category.name}
              className="group cursor-pointer overflow-hidden transition-smooth hover:shadow-medium"
            >
              <CardContent className="p-6 text-center space-y-4">
                <div className={`mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br ${category.color} flex items-center justify-center transition-smooth group-hover:scale-110`}>
